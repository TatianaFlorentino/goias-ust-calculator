  ...
  public: {
    Tables: {
      ...
      calculos_historico: {
        ...
        Relationships: [
          {
            foreignKeyName: "calculos_historico_projeto_id_fkey"
            columns: ["projeto_id"]
            isOneToOne: false
      ...
      configuracoes_complexidade: {
        Row: {
          complexidade: string
          created_at: string
          id: string
          multiplicador_horas: number
          perfis_obrigatorios: string[] | null
          squad_maximo: number
          squad_minimo: number
          tipo_projeto: string
        }
      ...
      squad_membros: {
        ...
        Relationships: [
          {
            foreignKeyName: "squad_membros_perfil_id_fkey"
            columns: ["perfil_id"]
            isOneToOne: false
            referencedRelation: "perfis_profissionais"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "squad_membros_squad_id_fkey"
            columns: ["squad_id"]
            isOneToOne: false
      ...
      squads: {
        ...
        Relationships: [
          {
            foreignKeyName: "squads_projeto_id_fkey"
            columns: ["projeto_id"]
            isOneToOne: false
            referencedRelation: "projetos"
            referencedColumns: ["id"]
